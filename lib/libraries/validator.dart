...
registerFirstname(String? val) {
  val = val.toString().trim();
  if (val == "" || val.isEmpty || val == "null") {
    return "Firstname belum diisi";
  }
  return null;
}

registerLastname(String? val) {
  val = val.toString().trim();
  if (val == "" || val.isEmpty || val == "null") {
    return "Lastname belum diisi";
  }
  return null;
}
